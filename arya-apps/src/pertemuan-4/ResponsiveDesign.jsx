  ...
  return (
    <div className="mb-4">
      ...
      <div className="flex flex-col md:flex-row mb-4 gap-4">
        <div className="bg-red-400 w-full md:w-1/2 p-4 text-white font-bold">Kolom 1</div>
        <div className="bg-blue-400 w-full md:w-1/2 p-4 text-white font-bold">Kolom 2</div>
      </div>
    </div>
  )
}
